...
sap.ui.define([
		...
		return BaseController.extend("ns.controller.Master", {
			...
			onCreateNewAd: function() {
			this._oCreateBookDialog = sap.ui.xmlfragment("ns.view.createAd", this);
		...
		onCancelAdCreation: function(oEvent) {
		...
		onCreateAd: function(oEvent) {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ns.view.ViewSettingsDialog", this);
