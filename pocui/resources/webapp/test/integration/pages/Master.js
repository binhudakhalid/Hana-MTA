							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("ads", {
											name : sCurrentId
										});
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "ads (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'ads (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all ads to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "ads (" + iExpectedLength + ")"}),
									success : function () {
